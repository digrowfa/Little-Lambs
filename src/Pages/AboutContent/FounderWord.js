                        ...
                        <div className="row d-flex justify-content-center">
                            <div className="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                                <div className="founderWords">
                                    ...
                                    <p>I am very proud to welcome you to Little Lambs Nursery – Dubai, a British curriculum nursery (EYFS), located in the heart of Al Karama.  As a mother, I truly understand that every parent is looking out for the best opportunities for their child/children. We at Little Lambs Nursery promises to provide a learning adventure combined with enjoyment and entertainment along with a secure learning environment for your little ones. Before you begin your journey with us, allow me to answer a few queries that may come to your mind.</p>
                                </div>
                            </div>
                        </div>
                        <div className="row">
