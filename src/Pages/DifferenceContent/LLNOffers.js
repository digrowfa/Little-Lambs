                                ...
                                <div className="LLNOfferCardBox">
                                    <div className="LLNOfferCard">
                                        ...
                                        <div className='LLNOfferCardContent'>
                                            ...
                                            <button>CHOOSE PLAN <img src={arrow} alt="arrow" className='img-fluid' /></button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="LLNOfferCard popular">
                                        ...
                                        <div className='LLNOfferCardContent'>
                                            ...
                                            <button>CHOOSE PLAN <img src={arrowBig} alt="arrow" className='img-fluid' /></button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="LLNOfferCard">
                                        ...
                                        <div className='LLNOfferCardContent'>
                                            <ul>
                                                ...
                                                <li>Termly payment </li>
                                                <li>second/ third term</li>
                                                <li>(jan-mar)(apr-june)</li>
                                            </ul>
                                            <button>CHOOSE PLAN <img src={arrow} alt="arrow" className='img-fluid' /></button>
                                        </div>
                                    </div>
