                    ...
                    <div className="container">
                        <div className="row d-flex justify-content-center">
                            <div className="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                                <div className="myChlidContent curriculumList">
                                    ...
                                    <ul>
                                        <li>
                                            <div className="curriculumListIcon">
                                                <img src={starPoint} alt="starPoint" className="img-fluid" />
                                            </div>
                                            <div className="curriculumListName">
                                    ...
                                    <p className="mt-5">Besides the seven areas LLN will focus on enhancing the understanding and civic awareness and pride of children through social studies; and teach the children the skills they would need for future through Information technology/STEM incorporated in the curriculum.</p>
